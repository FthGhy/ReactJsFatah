...
<nav className="bg-white dark:bg-gray-900 w-full z-20 top-0 start-0 border-b border-gray-200 dark:border-gray-600">
  ...
  <div class="w-12 h-12 bg-amber-700 dark:bg-violet-700 py-2">
    <p class="text-xs tracking-widest font-semibold text-putih text-center items-center">F A</p>
    <p class="text-xs tracking-widest font-semibold text-putih text-center items-center">T H</p>
  </div>
      <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Fatah</span>
  </a>
